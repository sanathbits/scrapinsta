...
async function main() {
 console.log("Starting main loop");
  setInterval(async () => {
    console.log("Running loop userDataCount", userDataCount, "googleKeepAliveCount", googleKeepAliveCount);
    userDataCount++;
...
let userDataCount=0;
let googleKeepAliveCount=0;

let targetUserDataCount=15;
let targetGoogleKeepAliveCount=60;
